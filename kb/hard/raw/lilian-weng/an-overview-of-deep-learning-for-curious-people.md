...
Illustration of the human visual cortex system. (Image source: [Wang & Raj 2017](https://arxiv.org/abs/1702.07800))
...
An autoencoder model has a bottleneck layer with only a few neurons. (Image source: Geoffrey Hinton’s Coursera class ["Neural Networks for Machine Learning"](https://www.coursera.org/learn/neural-networks) - [Week 15](https://www.coursera.org/learn/neural-networks/home/week/15))
...
The outputs of PCA (left) and autoencoder (right) when both try to compress documents into two numbers. (Image source: [Hinton & Salakhutdinov 2006](https://www.cs.toronto.edu/~hinton/science.pdf))
...
AlphaGo neural network training pipeline and architecture. (Image source: [Silver et al. 2016](https://www.nature.com/articles/nature16961))
