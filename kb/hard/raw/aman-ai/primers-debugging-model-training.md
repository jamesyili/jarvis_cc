...
* [Debugging Model Training](#debugging-model-training)
* [Framework for Debugging](#framework-for-debugging)
* [Sanity Check: Model Architecture and Data](#sanity-check-model-architecture-and-data)
* [Data issues](#data-issues)
* [Misaligned optimization and evaluation](#misaligned-optimization-and-evaluation)
* [Pipeline issues](#pipeline-issues)
* [Underfitting](#underfitting)
* [Overfitting](#overfitting)
* [Gradual Complexity Increase](#gradual-complexity-increase)
* [Gradient checking](#gradient-checking)
  + [Visualization activations and gradients](#visualization-activations-and-gradients)
...
* [Grad-CAM](#grad-cam)
* [Knowledge Distillation / Student-Teacher approach](#knowledge-distillation--student-teacher-approach)
* [Hyper-Parameter Optimization (HPO)](#hyper-parameter-optimization-hpo)
...
* Detailed explanation:
  + The optimization algorithms we usually use for training neural networks are deterministic. Gradient descent, the most basic algorithm, that is a base for the more complicated ones, is defined in terms of partial derivatives\[\theta\_{j}:=\theta\_{j}-\alpha \frac{\partial}{\partial \theta\_{j}} J(\theta)\]
...
```
@article{Chadha2020DebuggingModelTraining,
