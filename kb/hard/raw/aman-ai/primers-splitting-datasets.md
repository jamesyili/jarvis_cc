...
* [Choosing train, train-dev, dev and test sets](#choosing-train-train-dev-dev-and-test-sets)
* [Objectives](#objectives)
* [Dataset structure](#dataset-structure)
* [Reproducibility is important](#reproducibility-is-important)
* [Implementation details](#implementation-details)
  + [Ensure that train/dev/test belong to the same distribution (if possible)](#ensure-that-traindevtest-belong-to-the-same-distribution-if-possible)
  + [No randomness makes things reproducible!](#no-randomness-makes-things-reproducible)
...
* We talked [earlier](#reproducibility-is-important) about making our dataset building script reproducible. Here we need to make sure that the train/dev/test split stays the same across every run of `python build_dataset.py`.
