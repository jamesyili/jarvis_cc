...
* [Terminology](#terminology)
  + [Phoneme](#phoneme)
  + [Phone](#phone)
  + [Why do we need phonemes and phones?](#why-do-we-need-phonemes-and-phones)
  + [Allophones](#allophones)
    - [Environments of phonemes](#environments-of-phonemes)
  + [Graphemes](#graphemes)
  + [Mono vs. Stereo Sound](#mono-vs-stereo-sound)
  + [Key takeaways](#key-takeaways)
* [Feature Representations](#feature-representations)
  + [Oscillogram](#oscillogram)
  + [Spectrum](#spectrum)
  + [Spectrogram](#spectrogram)
  + [Why spectrograms?](#why-spectrograms)
* [How are tokenizers used for pre-processing speech input?](#how-are-tokenizers-used-for-pre-processing-speech-input)
* [What are “tokens” when embedding an audio sample using an encoder? How are they different compared to word/sub-word tokens in NLP?](#what-are-tokens-when-embedding-an-audio-sample-using-an-encoder-how-are-they-different-compared-to-wordsub-word-tokens-in-nlp)
  + [Mel-Filterbanks and MFCCs](#mel-filterbanks-and-mfccs)
  + [Example spectrogram and oscillogram](#example-spectrogram-and-oscillogram)
  + [Perceptual Linear Prediction (PLP)](#perceptual-linear-prediction-plp)
  + [Prosodic Features](#prosodic-features)
  + [Idiolectal Features](#idiolectal-features)
* [Speech Processing Tasks](#speech-processing-tasks)
  + [Architectural overview](#architectural-overview)
  + [Fundamental speech tasks](#fundamental-speech-tasks)
  + [Hierarchy of phones, words, and sentences](#hierarchy-of-phones-words-and-sentences)
  + [Automatic Speech Recognition](#automatic-speech-recognition)
    - [What is automatic speech recognition?](#what-is-automatic-speech-recognition)
    - [Framework of an ASR System](#framework-of-an-asr-system)
    - [Acoustic Model (Encoder)](#acoustic-model-encoder)
    - [Encoder-Decoder Architectures: Past vs. Present](#encoder-decoder-architectures-past-vs-present)
    - [Putting it all together](#putting-it-all-together)
  + [Keyword Spotting / Wakeword Detection](#keyword-spotting--wakeword-detection)
  + [Measuring Performance](#measuring-performance)
    - [Precision](#precision)
    - [Recall](#recall)
    - [Precision-Recall (PR) Curves](#precision-recall-pr-curves)
    - [F1-score](#f1-score)
    - [Detection Error Trade-off (DET) Curves](#detection-error-trade-off-det-curves)
    - [Online learning with live data to improve robustness](#online-learning-with-live-data-to-improve-robustness)
  + [Handling dynamic language switching and code switching](#handling-dynamic-language-switching-and-code-switching)
  + [Speaker Recognition](#speaker-recognition)
* [Data augmentation](#data-augmentation)
  + [Time domain](#time-domain)
    - [Gain](#gain)
    - [Types of noise](#types-of-noise)
      * [Reverberation noise / room impulse response (RIR)](#reverberation-noise--room-impulse-response-rir)
      * [Babble noise](#babble-noise)
    - [Speed and pitch](#speed-and-pitch)
    - [Codec augmentation](#codec-augmentation)
    - [Mixup](#mixup)
...
* [Evaluation metrics](#evaluation-metrics)
  ...
  + [Precision-Recall Curve](#precision-recall-curve)
    - [Area Under the PR Curve (AUC)](#area-under-the-pr-curve-auc)
  + [Key takeaways: Precision, Recall and ROC/PR Curves](#key-takeaways-precision-recall-and-rocpr-curves)
  + [Speech Recognition](#speech-recognition)
  + [Speech-to-Speech Machine Translation](#speech-to-speech-machine-translation)
  + [Manual evaluation by humans for fluency, grammar, comparative ranking, etc.](#manual-evaluation-by-humans-for-fluency-grammar-comparative-ranking-etc)
* [🤗 Open ASR Leaderboard](#-open-asr-leaderboard)
...
* Well, that’s new. This narrow transcription of the word puff gives us a little more information about how the word sounds. Here, we see that the `[p]` is aspirated. This means that when pronouncing the sound `[p]`, we have an extra puff of air that comes out. We notate this by using the superscript `ʰ`.
  So you are probably asking yourself, why don’t we just put the `ʰ` in the broad transcription? Remember that broad transcription uses phonemes and by definition, if we change a phoneme in a word, we will get a different word. Look at the following:
...
* The input audio (typically stored as a wave-file, but could be another audio format as well, such as FLACC, OGG, etc.) is converted to a feature sequence \((f\_1, \ldots, f\_T)\). The goal is to find a sequence of words \((w\_1, \ldots, w\_N)\) that matches the feature sequence best.
...
\[F\_1 = 2 \times \frac{\text{Precision} \times \text{Recall}}{\text{Precision} + \text{Recall}}\]
