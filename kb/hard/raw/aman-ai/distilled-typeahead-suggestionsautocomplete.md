...
* [High Level System Design](#high-level-system-design)
  + [Should we have case insensitive trie?](#should-we-have-case-insensitive-trie)
* [Detailed Component Design](#detailed-component-design)
  + [How to find top suggestions in the trie?](#how-to-find-top-suggestions-in-the-trie)
  + [Can we store top suggestions with each node?](#can-we-store-top-suggestions-with-each-node)
  + [How would we build this trie?](#how-would-we-build-this-trie)
  + [How to update the trie with new search queries?](#how-to-update-the-trie-with-new-search-queries)
  + [How can we update the frequencies of typeahead suggestions?](#how-can-we-update-the-frequencies-of-typeahead-suggestions)
  + [How can we remove a term from the trie?](#how-can-we-remove-a-term-from-the-trie)
  + [What could be different ranking criteria for suggestions?](#what-could-be-different-ranking-criteria-for-suggestions)
* [Permanent Storage of the Trie](#permanent-storage-of-the-trie)
* [Data Partitioning](#data-partitioning)
  + [Range Based Partitioning](#range-based-partitioning)
  + [Partition based on the maximum capacity of the server](#partition-based-on-the-maximum-capacity-of-the-server)
  + [Partition based on the hash of the term](#partition-based-on-the-hash-of-the-term)
* [Cache](#cache)
