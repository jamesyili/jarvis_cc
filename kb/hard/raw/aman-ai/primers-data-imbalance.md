...
* [Loss Function-based Methods](#loss-function-based-methods)
  + [Focal Loss](#focal-loss)
  + [Weighted Loss Functions](#weighted-loss-functions)
* [Model-based Methods](#model-based-methods)
  + [Benefits of Ensemble Methods for Class Imbalance](#benefits-of-ensemble-methods-for-class-imbalance)
  + [Bagging](#bagging)
  + [Boosting](#boosting)
* [Metrics-based Methods](#metrics-based-methods)
  + [Evaluation Metrics](#evaluation-metrics)
  + [Additional Diagnostic Tools (Confusion Matrix and Correlation Coefficients)](#additional-diagnostic-tools-confusion-matrix-and-correlation-coefficients)
...
* [FAQs](#faqs)
  + [How do ensemble methods help with class imbalance?](#how-do-ensemble-methods-help-with-class-imbalance)
    ...
    - [Hybrid Approaches](#hybrid-approaches-1)
...
* Example:
  \(w\_c = \frac{N}{n\_c},\)
  + where \(N\) is the total number of samples and \(n\_c\) is the number of samples in class \(c\).
...
* **Cohen’s Kappa**:
  ...
  + Effective for class imbalance, as it accounts for the disparity in class proportions.
    \(\text{Kappa} = \frac{P\_o - P\_e}{1 - P\_e},\)
...
* **Brier Score**:
  ...
  + Especially relevant for imbalanced datasets, where models often exhibit calibration issues due to overconfidence in the majority class.
    \(\text{Brier Score} = \frac{1}{N} \sum\_{i=1}^{N} (f\_i - y\_i)^2,\)
