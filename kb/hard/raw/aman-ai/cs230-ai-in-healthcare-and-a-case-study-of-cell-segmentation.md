...
* [AI in Healthcare](#ai-in-healthcare)
  + [Healthcare problems of interest](#healthcare-problems-of-interest)
  + [Paradigm Shift of Deep Learning](#paradigm-shift-of-deep-learning)
  + [On-going Research in the Stanford ML Group](#on-going-research-in-the-stanford-ml-group)
    - [1D example: Detecting Arrhythmias with CNNs](#1d-example-detecting-arrhythmias-with-cnns)
    - [2D example: Detection of Pneumonia on Chest X-Rays](#2d-example-detection-of-pneumonia-on-chest-x-rays)
    - [3D example: AI-assisted diagnosis for knee MR](#3d-example-ai-assisted-diagnosis-for-knee-mr)
* [Case Study: Cell Segmentation](#case-study-cell-segmentation)
  + [Data](#data)
  + [Architecture and Loss](#architecture-and-loss)
  + [Transfer Learning](#transfer-learning)
  + [Network Modification](#network-modification)

* In this topic, firstly we will present some applications of AI in Healthcare and then, we will go over a case study: **Cell Segmentation**. Here is the outline:
...
\[-\sum\_{i=1}^{n\_y} \left( y\_i \log(\hat{y}\_i) + (1-y\_i)\log(1-\hat{y}\_i) \right)\]
...
* Your model achieves a good performance; however, looking at your outputs, you realize that the boundaries between cells are not as clear as doctors want them to be. Since they want the model to help with cell identification, boundaries need to be clear.
