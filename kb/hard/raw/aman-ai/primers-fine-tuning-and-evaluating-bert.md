...
* [Inspect Dataset](#inspect-dataset)
  + [Inspect Training Samples](#inspect-training-samples)
* [Smart Batching](#smart-batching)
  + [Load Tokenizer](#load-tokenizer)
  + [Tokenize Without Padding](#tokenize-without-padding)
    - [Peak GPU Memory Use](#peak-gpu-memory-use)
    - [Tokenize, but don’t pad](#tokenize-but-dont-pad)
  + [Sort by length](#sort-by-length)
  + [Random Batch Selection](#random-batch-selection)
  + [Add Padding](#add-padding)
  + [Old Approach - Fixed Padding](#old-approach---fixed-padding)
...
* [Evaluate on Test Set](#evaluate-on-test-set)
  + [`make_smart_batches()`](#make_smart_batches)
  + [Load Test Dataset & Smart Batch](#load-test-dataset--smart-batch)
  + [Evaluate](#evaluate)
* [Appendix](#appendix)
  + [Smart Batching with `batch_encode_plus` and `DataLoader`](#smart-batching-with-batch_encode_plus-and-dataloader)
  + [Impact of `[PAD]` tokens on accuracy](#impact-of-pad-tokens-on-accuracy)
...
* To see how BERT does on the benchmark without smart batching, you can run the following code instead of the above sections: [Tokenize Without Padding](#tokenize-without-padding), [Sort by length](#sort-by-length), [Random Batch Selection](#random-batch-selection) and [Add Padding](#add-padding).
