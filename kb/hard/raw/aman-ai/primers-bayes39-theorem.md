...
* [History](#history)
* [A logical process for modern data science](#a-logical-process-for-modern-data-science)
* [Bayesian inference](#bayesian-inference)
* [Practical example with Python code](#practical-example-with-python-code)
  + [Drug screening](#drug-screening)
  + [What is fascinating here?](#what-is-fascinating-here)
  + [What level of test capability is needed to improve this scenario?](#what-level-of-test-capability-is-needed-to-improve-this-scenario)
* [Chaining Bayes’ rule](#chaining-bayes-rule)
* [Summary](#summary)
