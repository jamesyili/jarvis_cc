...
I created a Gist called [build\_microgpt.py](https://gist.github.com/karpathy/561ac2de12a47cc06a23691e1be9543a), where in the Revisions you can see all of these versions and the diffs between each step. I think this might be one helpful way to step through the code base, where you add one component at a time.
