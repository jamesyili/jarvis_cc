...
**Source:** https://eugeneyan.com//speaking/data-scientist-day-to-day/
**Ingested:** 2026-04-02
...
I recently had an interview with [CareerFair](https://www.careerfair.io) where we discussed these questions and more. (They also have other interviews with professionals in [marketing ops](https://www.careerfair.io/reviews/marketingoperationsmanager), [customer success](https://www.careerfair.io/reviews/customersuccessmanager), and [engineering](https://www.careerfair.io/reviews/software-engineer-interview-at-scratch-finance).) Here’s the interview write-up.
...
* **Reading**: [Reading papers](/writing/why-read-papers/) helps me to be a more effective data scientist. Thus, I try to read at least an hour a day. The content includes internal/external articles and papers. (I have a bias towards papers on [applied machine learning](https://github.com/eugeneyan/applied-ml).)
...
* **Migrating legacy systems**: All code eventually becomes legacy code. In a previous role, I was involved in a [massive migration](/speaking/datacast-eugeneyan/#what-were-the-challenges-faced-during-the-alibaba-acquisition-of-lazada) (cloud providers, data and machine learning systems) that needed us to drop everything and solely focus on migration.
...
I enjoy—and work best in—a role that’s between [commando and soldier](/writing/commando-soldier-police-and-your-career/). Both my experience in Lazada and Amazon allow me to do this which plays to my strengths.
...
> Interviewed Eugene Yan ([@eugeneyan](https://twitter.com/eugeneyan?ref_src=twsrc%5Etfw)) about his day to day at Amazon. He went from a Psych degree to being a Data Science veteran. Check the interview out here: <https://t.co/XihndB2BVG>
>
> — Shikhar Sachdev (@shikhar\_sachdev) [September 23, 2020](https://twitter.com/shikhar_sachdev/status/1308612798654668801?ref_src=twsrc%5Etfw)

  

If you found this useful, please cite this write-up as:

> Yan, Ziyou. (Sep 2020). CareerFair - Day-to-day as an Applied Scientist at Amazon. eugeneyan.com.
> https://eugeneyan.com/speaking/data-scientist-day-to-day/.

or

```
@article{yan2020careerfair,
  title   = {CareerFair - Day-to-day as an Applied Scientist at Amazon},
  author  = {Yan, Ziyou},
  journal = {eugeneyan.com},
  year    = {2020},
  month   = {Sep},
  url     = {https://eugeneyan.com/speaking/data-scientist-day-to-day/}
}
```
