...
In the [previous post](/writing/challenges-after-deploying-machine-learning/), we discussed six little-known challenges *after* deploying machine learning. As a recap, here are the six groups:
...
> Previous post: [6 Little-Known Challenges After Deploying ML](/writing/challenges-after-deploying-machine-learning/)

This follow-up will share some practices I’ve found useful to maintaining machine learning in production. They are:

* [Monitor Training and Serving Data for Contamination](#monitor-training-and-serving-data-for-contamination)
* [Monitor Models for Misbehaviour When Retraining](#monitor-models-for-misbehaviour-when-retraining)
* [Simplify Engineering to Reduce Operational Burden](#simplify-engineering-to-reduce-operational-burden)
* [Useful Practices to Minimize Feedback Loops and Bias](#useful-practices-to-minimize-feedback-loops-and-bias)
* [Structure Teams for Iteration and Innovation](#structure-teams-for-iteration-and-innovation)
* [Crowdsource the Handling of Customer Complaints](#crowdsource-the-handling-of-customer-complaints)

With close to 20 suggestions, it can get overwhelming. Fret not, I’ll highlight the top three **must-haves** and **good-to-haves** at the [end of this post](#thats-a-lot-how-should-we-prioritise).
...
**Thanks** to Yang Xinyi, Marianne Tan, and [Stew Fortier](https://stewfortier.com/) for reading drafts of this.

  

If you found this useful, please cite this write-up as:

> Yan, Ziyou. (May 2020). A Practical Guide to Maintaining Machine Learning in Production. eugeneyan.com.
> https://eugeneyan.com/writing/practical-guide-to-maintaining-machine-learning/.

or

```
@article{yan2020maintain,
