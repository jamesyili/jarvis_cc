...
**Source:** https://eugeneyan.com//writing/ml-design-docs/
**Ingested:** 2026-04-02
...
> This is part II of my answer to the top question on the [topic poll](https://www.dory.app/c/d5ae91d7/8898aab9_what-should-eugene-write-about-past-writing-https-eugeneyan.com-writing-/questions) (part I [here](/writing/writing-docs-why-what-how/)): *“How to write design documents for data science/machine learning projects?”*

> Also translated to [Japanese](https://zenn.dev/kaichi_nihira/articles/7048eabf9962e2) (by [Kaichi Nihira](https://x.com/kaichi_nihira))
...
We’ll go over pointers on what to cover in **design docs for machine learning systems**—these pointers will guide the thinking process. My design docs tend to be structured via the [Why, What, How](/writing/writing-docs-why-what-how/#writing-framework-why-what-how-who) framework shared last week (please skim it if you’ve not read it yet). Then, I’ll share how I get feedback via a two-step review process.

* [The Why and What of design docs](#the-why-and-what-of-design-docs)
* [The How of design docs](#the-how-of-design-docs)
* [Methodology: How to solve the problem with data and ML](#methodology-how-to-solve-problems-with-data-and-ml)
* [Implementation: How to build and operate the system](#implementation-how-to-build-and-operate-the-system)
* [Alternatives considered and rejected](#alternatives-considered-and-rejected)
* [Reviewing design docs in two stages](#reviewing-design-docs-in-two-stages)
...
**Validation and experimentation.** Explain how you’ll evaluate models offline. (IMHO, you won’t go wrong using a [time-based split](https://scikit-learn.org/stable/modules/cross_validation.html#time-series-split) *most* of the time.) Note the [difference](https://dl.acm.org/doi/10.1145/3383313.3418479) between leave-one-last, temporal, random, and user-based splits. Explain your choice of evaluation metrics(s) and why you think they are good proxy metrics for production conditions. If you’ve conducted experiments with validation results, include them.
...
Nonetheless, if you're still looking for a template to guide your thinking, here's a [minimal template](https://github.com/eugeneyan/ml-design-docs) that's deliberately lean.
...
> • Reviewing your design doc via a two-step process<https://t.co/KQYpZg0sCp>
>
> — Eugene Yan (@eugeneyan) [March 9, 2021](https://twitter.com/eugeneyan/status/1369115220803653638?ref_src=twsrc%5Etfw)
...
> Yan, Ziyou. (Mar 2021). How to Write Design Docs for Machine Learning Systems. eugeneyan.com.
