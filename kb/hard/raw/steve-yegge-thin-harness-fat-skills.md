---
title: "Thin Harness, Fat Skills — Steve Yegge"
source: Steve Yegge (via alejandrobalderas/claude-code-from-source)
domain: hard
tags: [agentic-systems, agent-architecture, claude-code, harness-design, skills, LLM-engineering]
