...
**Source:** https://louiswang524.github.io/blog/claude-code-multi-agent-patterns/
**Ingested:** 2026-04-05
**Tags:** llms, recsys, ai-agents, ml-systems

---

[Home](/) › [Blog](/blog) › Multi-Agent Patterns: Swarm, Teammates, and the Coordinator  
Multi-Agent Patterns: Swarm, Teammates, and the Coordinator
 
 March 31, 2026 · 9 min read  · [Claude Code](/tags/Claude Code)[multi-agent](/tags/multi-agent)[AI agents](/tags/AI agents)[concurrency](/tags/concurrency)[software architecture](/tags/software architecture) 
...
[In-Process Teammates via AsyncLocalStorage](#in-process-teammates-via-asynclocalstorage)
...
[The Permission Sync Problem](#the-permission-sync-problem)
...
**`tools/AgentTool/`** — the LLM-callable tool that spawns agents in response to model requests
 ...
 [ ← Previous Designing for Extensibility: How Claude Code's Plugin and Skill System Works ](/blog/claude-code-plugin-skill-system) 
 
 [ Next → Diffusion Language Models: How They Work, How They Compare to Autoregressive LLMs, and Where They're Going ](/blog/diffusion-llm)
