...
**Source:** https://louiswang524.github.io/blog/claude-code-plugin-skill-system/
**Ingested:** 2026-04-05
**Tags:** llms, recsys, ai-agents, ml-systems, claude-code

---

[Home](/) › [Blog](/blog) › Designing for Extensibility: How Claude Code's Plugin and Skill System Works  
Designing for Extensibility: How Claude Code's Plugin and Skill System Works
 
 March 31, 2026 · 9 min read  · [Claude Code](/tags/Claude Code)[plugins](/tags/plugins)[skills](/tags/skills)[MCP](/tags/MCP)[extensibility](/tags/extensibility)[software architecture](/tags/software architecture) 
...
[Skills — Prompt Injection as Extension](#skills--prompt-injection-as-extension)
...
[The Skill Registry and SkillTool](#the-skill-registry-and-skilltool)
...
[Plugins — Packages That Extend the Agent](#plugins--packages-that-extend-the-agent)
...
[MCP — The Open Protocol](#mcp--the-open-protocol)
...
**`services/mcp/`** — MCP client manager: server process lifecycle, tool registration, connection handling
 ...
 [ ← Previous Security Without a Sandbox: How Claude Code Decides What It's Allowed to Do ](/blog/claude-code-security-permissions) 
 
 [ Next → Multi-Agent Patterns: Swarm, Teammates, and the Coordinator ](/blog/claude-code-multi-agent-patterns)
