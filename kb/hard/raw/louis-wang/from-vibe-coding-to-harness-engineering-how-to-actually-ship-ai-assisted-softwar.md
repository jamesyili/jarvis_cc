...
**Source:** https://louiswang524.github.io/blog/vibe-coding-to-harness-engineering/
**Ingested:** 2026-04-05
**Tags:** llms, recsys, ai-agents, ml-systems

---

[Home](/) › [Blog](/blog) › From Vibe Coding to Harness Engineering: How to Actually Ship AI-Assisted Software  
From Vibe Coding to Harness Engineering: How to Actually Ship AI-Assisted Software
 
 March 23, 2026 · 10 min read  · [AI agents](/tags/AI agents)[software engineering](/tags/software engineering)[LLM](/tags/LLM)[productivity](/tags/productivity) 
...
[What Vibe Coding Is (And Why It Feels So Good)](#what-vibe-coding-is-and-why-it-feels-so-good)
...
[Where It Breaks Down](#where-it-breaks-down)

[1. Context Amnesia](#1-context-amnesia)
...
[2. No Verification Loop](#2-no-verification-loop)
...
[3. Architectural Drift](#3-architectural-drift)
...
[4. Production Blindspots](#4-production-blindspots)
...
[What Harness Engineering Is](#what-harness-engineering-is)
...
[The Four Pillars of a Good Harness](#the-four-pillars-of-a-good-harness)
...
[The Spectrum in Practice](#the-spectrum-in-practice)
...
**Vibe coding**Chat → accept → run → paste errorsScripts, prototypes, exploration

**AI-assisted engineering**Structured prompts + human review + manual testingFeatures within a larger system

**Agent harness**Loops + test gates + persistent stateProduction services, continuous iteration

**Spec-driven development**Specs as contracts, agents implement to themCritical systems, regulated industries
...
[How to Build Your First Harness](#how-to-build-your-first-harness)
...
*Further reading: Addy Osmani’s [Beyond Vibe Coding](https://beyond.addy.ie/), Martin Fowler’s [Harness Engineering](https://martinfowler.com/articles/exploring-gen-ai/harness-engineering.html), Anthropic’s [Effective Harnesses for Long-Running Agents](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents), and the OpenAI [Harness Engineering](https://openai.com/index/harness-engineering/) post.*
 ...
 [ ← Previous Why LLM Inference Costs Will Keep Falling ](/blog/inference-cost-trends) 
 
 [ Next → Generative Recommendation in Production: HSTU, OneRec, and What Every Major Platform Is Building ](/blog/generative-retrieval)
