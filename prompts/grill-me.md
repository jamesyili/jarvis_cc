...
4. **Challenge, don't just collect.**
   - If an answer conflicts with something in the context files or a prior decision in this interview, flag it.
...
If you lack the context needed to provide a good recommended answer — because the topic involves stakeholders, dynamics, or technical details not in the context files — say so explicitly. "I don't have enough context on [X] to recommend an answer here. What's the situation?" Do not fabricate plausible-sounding recommendations based on assumptions.
