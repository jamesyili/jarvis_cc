...
2. If this is a daily run, read the digest at `work/learning/digest/YYYY-MM-DD.md`
...
3. Cross-reference with `work/learning/learning_agenda.md` and `self/goals.md` for relevance
...
```bash
git add work/learning/articles/ work/learning/digest/ work/learning/.ingested_manifest.json
...
3. Update `work/learning/sources.md` with the new source details
4. Run `python scripts/ingest.py check-rss` to pull initial content

## Source Registry

See `work/learning/sources.md` for the full list of curated sources, their feeds, and sync status.
