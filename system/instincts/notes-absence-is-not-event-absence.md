...
### 2026-07-08
> "We talked about the 9mm stone and the decision is to monitor and drink lots of water."
Context: James pasted noisy notes from the Dr. Ha urology visit. Leo asserted "the 9 mm right stone never came up — still the biggest open item," marked it NOT DISCUSSED in health.md, and recommended messaging the clinic. It had been discussed — the notes just didn't capture it. Same principle as the Karen blind-spot rule (don't infer "not done" from file-tree absence), applied to event capture: the artifact is not the event.
