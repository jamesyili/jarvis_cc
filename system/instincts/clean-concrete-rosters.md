...
Context: Leo's two-track split tables annotated current reports with tags like "(on watch)", "(promo vehicle)", "(perf checkpoint)", "(manage)". James found the evaluative annotations confusing in what he was reading as an operational org chart.
Signal: correction.

### 2026-06-17
> "Give him actual people and scope." / "Just put Bella's name, not some weird backfill thing."
Context: Leo had described Alim's team partly via abstract "Bella backfill req" / headcount-path placeholders. James wanted concrete named people assigned, and Bella listed by name (she's a current person) rather than as a backfill abstraction.
Signal: correction.
