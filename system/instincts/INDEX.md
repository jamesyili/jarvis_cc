...
- **check-existing-context-before-analyzing** — about to analyze a known stakeholder/project → grep/read existing context first (team_members_scope.md, stakeholders.md, recent files); verify load-bearing facts; don't over-fortify on sensitive intel. **Fast-moving topic with a dated folder → `ls -t` it and read the NEWEST docs before answering** (7/31: answered reorg question from the June archive while reorg_july2026/ held the 7/24 design).
