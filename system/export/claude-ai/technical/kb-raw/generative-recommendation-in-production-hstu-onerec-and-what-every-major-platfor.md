...
**Source:** https://louiswang524.github.io/blog/generative-retrieval/
**Ingested:** 2026-04-05
**Tags:** llms, recsys, ai-agents, ml-systems

---

[Home](/) › [Blog](/blog) › Generative Recommendation in Production: HSTU, OneRec, and What Every Major Platform Is Building  
Generative Recommendation in Production: HSTU, OneRec, and What Every Major Platform Is Building
 
 March 23, 2026 · 14 min read  · [recommendation systems](/tags/recommendation systems)[generative AI](/tags/generative AI)[HSTU](/tags/HSTU)[OneRec](/tags/OneRec) 
...
[Why Two-Stage Pipelines Hit a Ceiling](#why-two-stage-pipelines-hit-a-ceiling)
...
[The Semantic ID Breakthrough](#the-semantic-id-breakthrough)
...
[Generative Retrieval: Replacing the First Stage](#generative-retrieval-replacing-the-first-stage)
...
[Generative Ranking: Replacing the Second Stage](#generative-ranking-replacing-the-second-stage)
...
ApproachRetrievalRankingPipeline

TraditionalShallow two-towerDLRM / shallow DNNTwo-stage

**LinkedIn****LLM two-tower****Large sequence transformer****Two-stage (upgraded)**

Meta HSTUGenerative—Retrieval replaced

Kuaishou OneRecGenerativeGenerativeFully collapsed
...
[Collapsing the Pipeline: End-to-End Generation](#collapsing-the-pipeline-end-to-end-generation)
...
[Reasoning Before Recommending](#reasoning-before-recommending)
...
Kwon et al. (2023). [Efficient Memory Management for Large Language Model Serving with PagedAttention](https://arxiv.org/abs/2309.06180). SOSP 2023.
 ...
 [ ← Previous From Vibe Coding to Harness Engineering: How to Actually Ship AI-Assisted Software ](/blog/vibe-coding-to-harness-engineering) 
 
 [ Next → The Harness Is the Moat: Why Autonomous AI Agents Live or Die by Their Architecture ](/blog/harness-is-the-moat)
