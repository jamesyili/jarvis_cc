...
Last updated: 2026-05-23 (full backlog reconciliation pass: marked done items per James's verbal sweep (KDD paper full draft / JJ packet ~done / Pinkerton M1+Jeff demo / VLM V0 / UPP×P2P OneTrans / Charlie CPP / Andrew Reflex+Pinkerton 1-pager / naming alignment / Piyush VLM access / Anna K cohort-mode / Hedi paper / Jeff predicted UIC demo / Daniel Liu 1:1 / Yan partner convo / Slack DM partnership signal / pre-June pod memo / Q2 self-review / H2 pre-seed memo / peer-EM coverage / mock dress rehearsal). Added new items: OpenAI May 27 call, Dylan team-design artifact delivery, Pod June Assignments Doc, P2P/Devin resource open question. Project files updated: `retentive_recs/retentive_recs.md` (May 2026 update: feedback loop launched on partial CG funnel = core RR hypothesis validated; pUIC dual-track timeline); `upp/upp_retrieval.md` (May 2026 update: Notif 3rd launch +200k WAU; P2P cross-surface pre-training infra built; eval-methodology debate; P2P/Devin resource open question). Memory saved: `feedback_james_comp_band` (Pinterest L18 ≈ $2M for James specifically, not standard L18 ranges).) 2026-05-22 (new `interview_prep/` directory stood up: OpenAI May 27 call prep consolidated to single doc; 6-story Pinterest grill plan; 16-file system design question bank extracted from 93-page PDF; LLM Systems Interview book + study plan. Haibo L EM eval added. Memories saved: feedback_email_md_files_by_default, feedback_update_in_place_not_companion, feedback_dont_over_pivot_to_seat_domain.)
