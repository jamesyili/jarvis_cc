...
**Why this program exists (clarified by James, 2026-09-05).** The 8/15 ruling: *I choose the LLM×recsys frontier, because it's where my time disappears — and I don't need anyone's building to pursue it.* This is that choice made executable. Build sustained technical depth across recommendation systems, retrieval, language models, and scaling: understand mechanisms, interrogate a RecGPT-class proposal at parity, review fine-tuning, reason about serving cost independently, and design Reflex's feedback loops from first principles. Hands-on exercises support that depth. The learning serves both James's ability to develop the organization's technical capability and his ability to demonstrate his own depth in frontier-lab interviews; see [goals.md](../goals.md) §Interview optionality and §Layer III C.

**Leo's role:** help James keep advancing day by day and week by week through this agenda, carrying forward what he has actually demonstrated and what remains unclear. Connect learning to team members' development and real technical work as those choices are made. Delivering a lesson is not evidence of mastery; an unchecked box is not evidence that James has not learned it elsewhere. The cadence, specific people, and organizational development plan remain to be designed with James.

**Practice-evaluator role (James, 2026-09-05; format clarified 2026-09-06):** James asked Leo to act as the demanding practice interviewer/evaluator. Infer two modes from his intent: **learning**, where questions, gaps, and outside sources receive explanation without performance critique; and **practice**, where open-ended architecture, loss-function, and system-design prompts elicit an extended answer for feedback. A request for help pauses critique even mid-practice. During practice, critique technical accuracy, design reasoning, precise terminology, and how clearly an interviewer can follow the answer. Quote his actual wording, offer better formulations and a tighter spoken version, and use targeted retries to train articulation over time. Elementary recall checks were explicitly too easy. The single [source directory](../interview_prep/interview_sources_and_mock_providers.md) grounds lab-related exercise selection. Evaluate observed answers with explicit technical evidence; the research does not establish access to private lab rubrics or certify hiring readiness. Informal learning checks have begun; no formal diagnostic loop or recurring mock cadence has run.
...
**Personal capacity input (James, 2026-09-05):** when discussing the balance among the Exceeds campaign, technical learning/interview preparation, and gaming, James reported "an hour a day during most weekdays and 3–4 hours each weekend" of discretionary time. Weekend total versus per-day was not explicitly distinguished. James subsequently ratified the recommendation: protect approximately three focused learning hours weekly, use much of the remaining discretionary time for games, and revisit actual external opportunities after January 2027 calibration. The conservative 7–9-hour total is an estimate, not a quota. See `self/goals.md` for the accepted balance and `work/career/exceeds_h2_2026_campaign.md` for the work sequence.

**Scope:** the existing 14-week sequence and ~3 hrs/week budget stand. On 8/30, deeper pretraining and dedicated interview drilling were deferred pending a calm-week check. The September 5 decision now supplies the operative sequence: ongoing depth now, an active external campaign only after January calibration. The 9/5 clarification makes interview-relevant technical depth an explicit ongoing purpose, not something gated on deciding to leave. James's 9/6 direction adds open-ended technical articulation practice inside ordinary learning sessions, with feedback and retries guiding the next explanation. Informal checks have begun; no formal diagnostic loop, recurring mock cadence, or added pretraining module is scheduled. Old non-technical tracks (Claude Code mastery, eng leadership, ML system design) continue ambiently, not as curriculum.

**Continuation (2026-09-06):** invoke `$learn` or say "continue learning." [`learning_progress.md`](learning_progress.md) holds the exact lesson/block, pending question, answer evidence, and device display result. The agenda owns the course sequence; the progress file owns the resume point. A delivered lesson is not a completed lesson.
