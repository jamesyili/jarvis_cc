...
**Scope:** the existing 14-week sequence and ~3 hrs/week budget stand. On 8/30, deeper pretraining and dedicated interview drilling were deferred pending the calm-week test (~mid-Sept). The 9/5 clarification makes interview-relevant technical depth an explicit ongoing purpose, not something gated on deciding to leave. It does not yet add a pretraining module, schedule interview rounds, or expand the time budget. Old non-technical tracks (Claude Code mastery, eng leadership, ML system design) continue ambiently, not as curriculum.
