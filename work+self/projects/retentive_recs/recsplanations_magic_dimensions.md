...
**Scope:** Product-direction thinking. **NOT** load-bearing evidence for the team-design / reorg case — that conversation stays clean. See `work+self/people/dylan_team_design_artifact_draft_v1.md` + `dylan_team_design_input_2026-05.md` for the team-design workstream.
