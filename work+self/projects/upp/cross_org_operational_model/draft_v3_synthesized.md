...
> **Pending addendum (2026-05-13):** Coupled-design info-sharing protocol — EM-to-EM heads-up before LR approval whenever a surface team's parallel scaling work crosses from exploratory to candidate. Triggered by OneTrans surprise (see `upp_retrieval.md` 5/13 status). To be memorialized after joint half-pager lands with leadership. Sai committed to the protocol in 5/13 noon 1:1.
