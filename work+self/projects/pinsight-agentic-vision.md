...
### 2.10 Eval harness (**biggest unknown, needed for Phase 3+**)
...
2. **Who owns Phase 3+?** M1 is ~10 hrs, M2 is weeks, Phase 3+ is months. The current staffing table ends at Alok extending M1. Where does the rest of the team come from? Darren's DS? A new hire? This is a strategic question for Dylan.

3. ~~**Is the simulation harness worth the bet?**~~ **Resolved 2026-04-05 (Fork A):** Yes, committed, with held-out prediction gate on M2 profiles. See Phase 4.
