...
- **Source material:** HF Triage oncall logs (past quarter) at `work+self/people/charlie_pip_project2_oncall_source.md` on your manager's machine — James will hand you the needed extracts.
