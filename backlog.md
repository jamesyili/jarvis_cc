...
| 8 | **Stand up the three-EM org → Oct end-state** | EM sync running; Oct decisions made on criteria, not advocacy | ~~GenRet graduation/sunset criteria before 8/17~~ **RETIRED 8/2 (James): GenRet = gains engine to scale, not an incubation awaiting a graduate-or-sunset call — no artifact owed** · **organizing-axis choice = the new pre-kickoff thinking** (`p13n_retrieval_split.md`) · sync kickoff ~8/17 (decision rights + settled/open lists + five principles) · Oct: axis, CLR, GenRet landing, IB gate, UEB, Balaji, 2 reqs, remaining lines | `reorg_july2026/p13n_retrieval_split.md` (Parts 0/1/2) |
