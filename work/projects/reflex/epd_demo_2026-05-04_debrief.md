...
- `work/projects/pinkerton/epd_demo_2026-05-04_prep.md` — pre-demo prep + Q&A bank (15 anticipated)
- `work/people/pre_june_readiness.md` — May posture section (Sponsor Stack typology, Q11 5-signal dashboard, calibration-window framework)
- `work/people/jeff_rajat_office_hours_prep.md` — 5/2b + 5/3 prep updates
- `work/career/H1_career_convo.md` — Dylan career convo (week of 5/20)
- `work/people/stakeholders.md` — full stakeholder profiles
