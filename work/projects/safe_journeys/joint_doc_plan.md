...
**D12 — RATIFIED upward (James, confirmed 9/1): GenAI-first was raised with Dylan and she acknowledged it; she thanked James for being the POC on CQ (9/1 1:1).** The 8/31 SJ summary's "soften to proposed" hedge is retired — GenAI-first is the sequencing of record with her. *(Original, 2026-08-25, proposed — needs James):* re-instantiate the framework on GenAI; absorb the 12-week distribution lane as Phase 1.** Per Michael/Andrew's sequencing (GenAI = first CQ-aware-ranking use case; self-harm rides the long-term solution), the doc's worked example flips from teen self-harm to GenAI and self-harm becomes the second instantiation on the same mechanisms. The doc doesn't invent a GenAI workplan — it absorbs the one already running (HF L1 utility demotion for opt-out users · P2P L2 demotion + spacing with CQ · v3.1 migration · DQv4 demotion) and states what it adds on top:
...
**Update (2026-08-27 AM, James verbal):** James has **already sent Michael his input on the Safe Journeys plan** (the 8/25 9:44 AM commitment #3 — "help on the SJ plan" — is delivered on James's side; content not pasted). Michael's Fri 8/28 target (plan → Andrew/Dylan/Faisal) stands; Michael's draft itself still unfiled here.

**Update (2026-08-27 AM) — Michael's appended updates (source 08 addendum 3):** **TPM assigned — Ambica Bhardwaj** (reverses 8/25 "no TPM"); program scope widened to "anything that intersects with borderline content distribution"; Ambica → **Melissa Saboowala** for Safe Journeys metrics support; Michael drafting a **success-metrics proposal** for James's add/remove. James's precise answer on support: measurement DS for **self-harm WS1 + the retention holdout** (GenAI already has Wenjun Wang). Defend the framework's WS2/WS3 scope as the program widens.
