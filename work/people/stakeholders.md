...
- **One narrative flag (low stakes, cheap counter):** "it expands my original doc" keeps a parent-document story with his doc as the seed. Gracious, not hostile — but if it echoes upward ("James expanded Qinglong's doc") it dilutes first-authorship in front of Faisal/Michael/Bill. Counter in circulation language, not in reply: consistently call it "the framework Qinglong and I are co-authoring" in WG posts and share-outs.
