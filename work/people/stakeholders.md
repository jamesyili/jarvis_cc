...
- **Anna Kiyantseva (Principal PM — promoted 9/4/2026, the only PM at that level company-wide; PM partner for Retentive Recommendations / Pinner Progression)** — co-owns product narrative; inner circle ally. Full profile §2.
...
**Updated 2026-09-04: PROMOTED TO PRINCIPAL PM — the only PM at that level in all of Pinterest** (James's words; DM exchange Fri 9/4, 5:26–5:38 PM). James: *"Omg did you get promoted????? Holy shitt congrattsssss"* → Anna: *"Awwww thank you so much!!!!!! [blushing emoji ×4] I ONLY HOPE TO BE WORTHY OF MY NEW ALLITERATIVE TITLE"* → James: *"Pinner Progression Principal Product Perfect Person????"* → Anna, quoting it back with a strikethrough: *"Pinner Progression Principal Product ~~Perfect~~ Pebble Person????"* (🪨 reaction — "pebbling" = her sharing-videos-as-affection register; insider language, keep using it).

- **The April arc closes.** Apr 27 she deflected James's "distracting myself from career progress" with *"what career stuff???? my level progression in DOS2???"* — she was processing her own case in parallel and didn't say so. ~4 months later she holds the only Principal PM title at the company. Her 7/1 read on James (*"you'll get promoted, just a matter of time — that simple"*) now comes from someone who has just been through the mechanism herself, at the top IC altitude on her ladder — and who therefore knows what an above-the-line packet looks like from the product side. **She is now a live source on packet shape, not only on Dylan's mood.**
- **What it validates.** The promotion rides on the Pinner Progression / Retentive Recs line — the bet James built the technical half of (RR = the "named technical key" under the Anticipation Vision; §9 Andrew's 8/27 org-change announcement already named UPP + Anticipation Cupcake as his credential). The product org is stacking costly public signals on this line. **Honest boundary:** her ladder (Andrew → Vicky) ≠ James's (Dylan → Rajat → Jeff); this is a receipt for the bet, not for James's case. His case still needs his own landings (A-row, `../career/exceeds_h2_2026_campaign.md`).
- **Sponsor weight up, continuity risk down.** The role description below — "the lens through which Dylan views your success"; "invisible authoring partner" who sells the technical strategy to Andrew and the CTO — now carries a Principal title in those rooms. Someone promoted to a unique level is not leaving soon: one leg of the Exceeds residual "sponsor continuity" risk just got firmer. The 4-way nexus (Andrew + Dylan + Anna + James) strengthened on the product side.
- **Operating adjustments (small):** (1) The "Professional Brand Leakage" risk below matters more now that her visibility is higher — nap-time register stays in DMs; Sharp Strategic Partner mode in any room with Andrew/Vicky/Dylan, so she looks the part by association. (2) "Invisible support" is worth more than ever: the ~9/24 pUIC readout and blog Part 2 are the first RR artifacts she carries at the new level — prep the team so she looks great. (3) If the promotion gets a public announcement (Andrew/Vicky channel), one line from the eng partner naming the concrete thing she did on RR is the cheapest amplification available — High I rewards public camaraderie; the peer DM is already sent. (4) Expect her scope to keep rising under Andrew; the "deliver the how so she can sell the what" loop is unchanged, with a bigger audience.
...
## 2026-09-08: Intelligent Boards bulk-save signal discussion

**Discussion record:** [Intelligent Boards bulk saves](../projects/intelligent_boards_bulk_save_2026-09.md) holds the first two photo transcripts and reasoning through Michael's acceptance. **The later exchange and current stance are below**; the dedicated document remains open in the edit viewer and still carries the earlier pause recommendation. Merge this continuation when that review is finished. The original opener says filtering saves "will affect" UIC generation; the first summary's implication that filtering was deployed is withdrawn.

**Relationship signal:** Andrew publicly defended the strong immediate feed effect after several participants raised concerns; his reply was also broadcast to #p13n-all. James finds the tone pushy, is skeptical of the product prediction without data, and explicitly wants to protect this important relationship while holding the differentiation/calibration and user-recovery concerns. His reaction is recorded as his view; deliberate personal rebuke or withdrawn sponsorship is not established. Andrew's July endorsement of James's judgment and crucial conversations, alongside his patience feedback, remains the relevant prior.

**Earlier outcome:** Michael reports pool-board saves dominating Explore/Homefeed and requiring more than a week of active interaction to recover. Andrew clarifies that metadata creates optionality to treat bulk saves differently and tune their influence, while preserving his preference for the bolder baseline. James then reports Michael's close: "Yup. Makes sense. I missed the ‘additional metadata’ suggestion." Leo initially recommended leaving the exchange closed. **That advice was superseded when James chose to reply, and the third screenshot confirms he did.**

**Latest outcome, third screenshot (phone clock 5:48; messages show relative times):** James publicly accepts optionality and a bold baseline, raises the possibility that ranking/retrieval models need rebuilding because influence is machine-learned through user sequences, and tags Dhruvil. He also asks for a way to reverse unwanted recommendation effects. Andrew replies "Great point on #2," tags Emun Solomon and Kirsten Browne, and suggests triggering See More / See Less more often to collect feedback, tagging Lily Li. **James reports that Andrew remains insistent on #1; the supplied third screenshot shows the response to #2 but no new #1 argument.** Positive acknowledgment of the agency concern is observed; no undo implementation or rollback guarantee is agreed. James now asks for tactical options to earn trust through useful investigation, including joint work with his team/Ranking and use of Reflex, before deciding further messaging.

**Third-photo transcription (verbatim readable text; line wrapping normalized, reactions omitted):**
...
**Current Leo tactical recommendation, not a James decision:** organize a bounded joint investigation with the existing IB/retrieval owner and the ranking-sequence owner Dhruvil identifies, using Reflex for code/data evidence. First try to falsify the premise that model rebuilding is unavoidable: identify actual controls before/within sequence construction, metadata propagation, and what truly needs training changes. Return the fastest credible test path with costs, remaining uncertainty, and recovery behavior; do not produce a solo rebuttal or treat a Reflex-generated conclusion as validated. James frames the decision and reviews the result; code owners drive implementation. The recent TP session with JJ, recorded in `projects/reflex/program_state.md` on 9/8, demonstrates Reflex-assisted data/code investigation and experimental-arm planning; it does not prove access or capability for every IB/Ranking path. More See/See Less feedback and actual reversal are distinct behaviors to verify. No message sent by Leo; no investigation or experiment launched here.
