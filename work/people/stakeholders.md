...
## Yuke (IC15, RecGPT-only since 7/7; ex-Retentive Recs TL — updated 2026-08-08)
- **2026-08-08 — performance-management state:** H1 downward letter (final, revised 8/8) delivering wk of 8/10 after ER pre-review — **ER (Employee Relations Specialist) engaged.** Yuke in documented self-defense mode since the 7/27 contest (solicited-reviewer glow, linked rebuttals to any relayed feedback, for-the-file register). James's posture, set 8/8: **exit the evidence war** — ledger + dated H2 goals are the instrument; no soliciting peer feedback in either direction; no real-time secondhand relays; never litigate artifact-by-artifact. Peer file itself is NOT a whitewash (Anna + Yidi corroborate the letter; see `downward_reviews/h12026/yuke_peer_feedback_verbatim_2026-08.md`). **Live option (unratified): reassign to Alim** (or Daniel — GenRet scope fit, but junior) for a neutral read; gated on ER's manager-change answer; handoff brief = instruments, not narrative. Trust James→Yuke is broken bidirectionally — argument for not being his manager, not automatically for exit. AC21 note stands: green-card self-resolution changes humane exit timing if it comes to that.
- **Status (2026-04-11, pre-dating the above):** Flight risk. Bowen reported Yuke asking interview questions about market pay. Unhappy about promo deferral.
