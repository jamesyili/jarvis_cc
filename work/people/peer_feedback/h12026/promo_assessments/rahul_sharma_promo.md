# Rahul Sharma — Promo Assessment (M15 → M16), July 2026
...
My exposure to Rahul comes from the customer side of his team's work: Homefeed depends on CSI, and Rahul and I have mostly interacted at the operational seam between the two orgs. Within that scope, he has demonstrated real capability at the next level in partnership across teams and in operational leadership.

The clearest example is the operations meeting series between CSI and Homefeed. When the other CSI leads were unable to attend, Rahul stepped up as the main point of contact and carried the forum himself. He kept both organizations aligned on urgent priorities and moved escalations along rather than letting the series stall until more senior people were back in the room. This aligns with the M16 expectation to "build partnerships with cross-functional stakeholders and engineering leaders to influence outcomes and build consensus," and he did it in a situation where the easier move was to wait.
...
Where Rahul needs to develop for M16, from what I can see, is in setting and visibly upholding the technical bar for his own team. The M16 REG expects a manager to raise the technical bar "by supporting and challenging engineers as they produce designs and implementations" and to provide "actionable feedback on technical artifacts," proactively addressing low performance along the way. I have not seen Rahul operate in that mode, and the one case I observed closely pointed the other way. Ngan struggled with DynamicSizer for an extended stretch, and it took sustained back and forth between Rahul and the EM under me at the time to finalize staffing and get her on the right track. From where I sat, Rahul could have stepped in earlier, both to correct course directly and to set more examples of what good looks like technically.

I want to be fair about the limits of my vantage point: the customer side is not where a manager's technical coaching is most visible, and this may be happening in rooms I am not in. But if it is, it has not shown through in our shared work, and it is the dimension I would probe before calling him ready.

**Q: Based on your experience working with the employee, how would you assess their readiness for the next level?**

☑ Can't fully assess: I don't have enough direct exposure to make a confident call
