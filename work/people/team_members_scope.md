...
Last updated: 2026-08-01 (rename + org-shape/scope sections built from `reorg_july2026/` full context: org = P13N Retrieval, three teams locked, announcement Wed 8/5. Prior: 2026-07-31 midyear-review sweep — all 13 H1 docs in `downward_reviews/h12026/`; Bella/Yuke/Zili/Alok 7/31 entries below.)
...
| RecGPT / Generative Retrieval | James (incubation) | Bella | Time-boxed incubation; graduation destination decided at the ~Oct design point (Alim's team was the July lean) |
...
- **Generative retrieval:** RecGPT/GenRet incubation (time-boxed, graduation/sunset criteria).
