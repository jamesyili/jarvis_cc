...
| **Daniel Liu** | **M16** MLE | (current) EM on Curation ML | Supports 8 ICs (+Esteban, surfaced 8/3) + intern; comes to James via Dylan's reorg. **8/3: T1 team name = his call (James DM); "Curation ML" is the default until he responds** |
