...
| **Alim Virani** (he/him) | **M16** MLE | Anticipation Modeling | **Started 7/27/2026** — see Tier-1 entry |
...
| Zili Li | L14 | MLE | LWS | James | **PIP initiated 2026-07-22 (ER engaged)**; James keeps it |
...
### Alim Virani (M16, ML Engineering Manager II — Anticipation Modeling) — STARTED 7/27/2026

- **Role:** EM for Anticipation Modeling (name locked 7/24; "Interest Modeling" = fallback). Day-1 pod: Chuxi (L14) / Yidi (L13) / Alok (L14, reporting line unresolved) / Lionel (L14, also started 7/27). No Staff/L15 in pod day-1 (Zihao unresolved — see his entry).
...
### Zili — PIP initiated (2026-07-22)
- **Workstream:** LWS
- **1:1:** Tue 1:30pm monthly
- **2026-07-22 DECISION — PIP:** James decided to PIP Zili and has **reached out to ER to start the process.** Ends the "manage rather than exit" holding pattern below (the backfill-constraint logic no longer overrides the documented, recurring pattern). Formalizes the "open perf case James keeps" from the org-design docs.
