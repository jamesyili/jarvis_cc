...
*Sources: SASRec (Kang & McAuley 2018); Yi et al. 2019 "Sampling-Bias-Corrected Neural Modeling for Large Corpus Item Recommendations" (in-batch negatives + logQ); your `artifacts/transformers-for-recsys.html` (Parts 2–3, 6) and `work+self/projects/upp/cfm_technical.md` (FM-vs-CFM loss/negatives).*
